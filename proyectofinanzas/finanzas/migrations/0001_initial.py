# Generated by Django 2.1.7 on 2019-03-09 18:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(help_text='ID Tipo de Transaccion', primary_key=True, serialize=False)),
                ('Descripcion', models.CharField(help_text='Descripcion', max_length=50)),
                ('Activo', models.BooleanField(default=1)),
                ('Tipo', models.CharField(choices=[('I', 'Ingresos'), ('E', 'Egresos'), ('R', 'Renglones de Egresos'), ('P', 'Tipos de Pagos')], default='', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Transacciones',
            fields=[
                ...
                ('TipoPago', models.CharField(choices=[('T', 'Tarjeta de Credito'), ('E', 'Efectivo'), ('C', 'Cheque')], default='', max_length=1)),
